...
public class Manager extends Utilisateur {
	...
	public class JPasswordField2 implements ActionListener {
	  ...
	  public void actionPerformed(ActionEvent e) {
		int comparaison = String.copyValueOf(passwordField1.getPassword()).compareToIgnoreCase(String.copyValueOf(GestionBDD.select(motDePasse)));
		if(comparaison == 0) {	// Le mot de passe est le bon
